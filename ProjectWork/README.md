...
.  
        ...
        192.168.2.0/24, ubest/mbest: 1/0, attached
            *via 192.168.2.1, Vlan2, [0/0], 2d20h, direct
        192.168.2.1/32, ubest/mbest: 1/0, attached
            *via 192.168.2.1, Vlan2, [0/0], 2d20h, local
        192.168.2.10/32, ubest/mbest: 1/0
            *via 10.255.50.105%default, [200/0], 00:00:46, bgp-65020, internal, tag 6501
        0 (evpn) segid: 9999 tunnelid: 0xaff3269 encap: VXLAN

        192.168.2.20/32, ubest/mbest: 1/0, attached
            *via 192.168.2.20, Vlan2, [190/0], 20:34:45, hmm
        192.168.12.0/24, ubest/mbest: 1/0, attached
            *via 192.168.12.1, Vlan12, [0/0], 20:45:23, direct
        192.168.12.1/32, ubest/mbest: 1/0, attached
            *via 192.168.12.1, Vlan12, [0/0], 20:45:23, local
        192.168.12.10/32, ubest/mbest: 1/0
            *via 10.255.50.102%default, [200/0], 06:47:55, bgp-65020, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3266 encap: VXLAN

        192.168.12.20/32, ubest/mbest: 1/0
            *via 10.255.50.105%default, [200/0], 00:00:46, bgp-65020, internal, tag 6501
        0 (evpn) segid: 9999 tunnelid: 0xaff3269 encap: VXLAN

        192.168.15.0/24, ubest/mbest: 1/0, attached
            *via 192.168.15.1, Vlan15, [0/0], 20:45:22, direct
        192.168.15.1/32, ubest/mbest: 1/0, attached
            *via 192.168.15.1, Vlan15, [0/0], 20:45:22, local
        192.168.15.10/32, ubest/mbest: 1/0
            *via 10.255.50.102%default, [200/0], 06:47:55, bgp-65020, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3266 encap: VXLAN
...
.  
        ...
        BGP table version is 3208, Local Router ID is 192.168.2.1
        ...
        *>i192.168.2.10/32    10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>i192.168.12.10/32   10.255.50.102                     100          0 i
        * i                   10.255.50.102                     100          0 i
        *>i192.168.12.20/32   10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
...
.  
        ...
        BGP table version is 66508, Local Router ID is 10.255.11.2
        Status: s-suppressed, x-deleted, S-stale, d-dampened, h-history, *-valid, >-best
        Path type: i-internal, e-external, c-confed, l-local, a-aggregate, r-redist, I-i
        njected
        Origin codes: i - IGP, e - EGP, ? - incomplete, | - multipath, & - backup
        ...
        Network            Next Hop            Metric     LocPrf     Weight Path
        Route Distinguisher: 10.255.11.2:32769    (L2VNI 10002)
        *>i[2]:[0]:[0]:[48]:[0050.7966.6812]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        x i                   10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.6813]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100      32768 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
                            10.255.50.105                     100          0 65010 i
        x i                   10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
                            10.255.50.101                     100      32768 i
        *>l[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100      32768 i
        *>i[3]:[0]:[32]:[10.255.50.102]/88
                            10.255.50.102                     100          0 i
        * i                   10.255.50.102                     100          0 i
        *>i[3]:[0]:[32]:[10.255.50.105]/88
                            10.255.50.105                     100          0 65010 i
        x i                   10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i

        Route Distinguisher: 10.255.11.2:32779    (L2VNI 10012)
        ...
        *>i[2]:[0]:[0]:[48]:[0050.7966.6811]:[0]:[0.0.0.0]/216
        ...
        x i                   10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
                            10.255.50.102                     100          0 i
        * i                   10.255.50.102                     100          0 i
        ...
        * i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.11.2:32782    (L2VNI 10015)
        *>i[2]:[0]:[0]:[48]:[0050.7966.680f]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        * i                   10.255.50.102                     100          0 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.680f]:[32]:[192.168.15.10]/272
                            10.255.50.102                     100          0 i
        * i                   10.255.50.102                     100          0 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
                            10.255.50.101                     100      32768 i
        *>l[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100      32768 i
        *>i[3]:[0]:[32]:[10.255.50.102]/88
        ...
        * i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.11.3:3
        * i[2]:[0]:[0]:[48]:[5000.0005.0007]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i

        Route Distinguisher: 10.255.11.3:32769
        * i[3]:[0]:[32]:[10.255.50.102]/88
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i

        Route Distinguisher: 10.255.11.3:32779
        * i[2]:[0]:[0]:[48]:[0050.7966.680e]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
        ...
        *>i                   10.255.50.102                     100          0 i
        ...
        Route Distinguisher: 10.255.11.3:32782
        * i[2]:[0]:[0]:[48]:[0050.7966.680f]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.680f]:[32]:[192.168.15.10]/272
        ...
        *>i                   10.255.50.102                     100          0 i
        ...
        Route Distinguisher: 10.255.11.4:3
        * i[2]:[0]:[0]:[48]:[5000.0006.0007]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i

        Route Distinguisher: 10.255.11.4:32769
        * i[3]:[0]:[32]:[10.255.50.102]/88
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i

        Route Distinguisher: 10.255.11.4:32779
        *>i[2]:[0]:[0]:[48]:[0050.7966.680e]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        * i                   10.255.50.102                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
        ...
        *>i                   10.255.50.102                     100          0 i
        ...
        Route Distinguisher: 10.255.11.4:32782
        * i[2]:[0]:[0]:[48]:[0050.7966.680f]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 i
        *>i                   10.255.50.102                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.680f]:[32]:[192.168.15.10]/272
        ...
        *>i                   10.255.50.102                     100          0 i
        ...
        Route Distinguisher: 10.255.21.1:3
        * i[2]:[0]:[0]:[48]:[5000.000a.0007]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        *>i                   10.255.50.105                     100          0 65010 i

        Route Distinguisher: 10.255.21.1:32769
        * i[2]:[0]:[0]:[48]:[0050.7966.6812]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        *>i                   10.255.50.105                     100          0 65010 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
        ...
        *>i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.21.1:32779
        * i[2]:[0]:[0]:[48]:[0050.7966.6811]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        *>i                   10.255.50.105                     100          0 65010 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
        ...
        *>i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.21.1:32782
        * i[3]:[0]:[32]:[10.255.50.105]/88
                            10.255.50.105                     100          0 65010 i
        *>i                   10.255.50.105                     100          0 65010 i

        Route Distinguisher: 10.255.21.2:3
        * i[2]:[0]:[0]:[48]:[5000.0009.0007]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        *>i                   10.255.50.105                     100          0 65010 i

        Route Distinguisher: 10.255.21.2:32769
        *>i[2]:[0]:[0]:[48]:[0050.7966.6812]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
        ...
        * i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.21.2:32779
        *>i[2]:[0]:[0]:[48]:[0050.7966.6811]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
        ...
        * i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.21.2:32782
        *>i[3]:[0]:[32]:[10.255.50.105]/88
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i

        Route Distinguisher: 10.255.11.2:3    (L3VNI 9999)
...
Выборочный вывод по хостам. 
   ...
   *Leaf1-4*  
        ...
        Leaf1-4# sho nve peers
        Interface Peer-IP          State LearnType Uptime   Router-Mac
        --------- ---------------  ----- --------- -------- -----------------
        nve1      10.255.50.101    Up    CP        07:26:52 5000.0003.0007
        nve1      10.255.50.105    Up    CP        06:23:50 5000.0009.0007

.  

        Leaf1-4# show ip route vrf VTBL
        IP Route Table for VRF "VTBL"
        '*' denotes best ucast next-hop
        '**' denotes best mcast next-hop
        '[x/y]' denotes [preference/metric]
        ...
        192.168.2.0/24, ubest/mbest: 1/0, attached
            *via 192.168.2.1, Vlan2, [0/0], 08:11:03, direct
        192.168.2.1/32, ubest/mbest: 1/0, attached
            *via 192.168.2.1, Vlan2, [0/0], 08:11:03, local
        192.168.2.10/32, ubest/mbest: 1/0
            *via 10.255.50.105%default, [200/0], 00:00:06, bgp-65020, internal, tag 6501
        0 (evpn) segid: 9999 tunnelid: 0xaff3269 encap: VXLAN

        192.168.2.20/32, ubest/mbest: 1/0
            *via 10.255.50.101%default, [200/0], 07:27:46, bgp-65020, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3265 encap: VXLAN

        192.168.12.0/24, ubest/mbest: 1/0, attached
            *via 192.168.12.1, Vlan12, [0/0], 08:11:02, direct
        192.168.12.1/32, ubest/mbest: 1/0, attached
            *via 192.168.12.1, Vlan12, [0/0], 08:11:02, local
        192.168.12.10/32, ubest/mbest: 1/0, attached
            *via 192.168.12.10, Vlan12, [190/0], 07:38:24, hmm
        192.168.12.20/32, ubest/mbest: 1/0
            *via 10.255.50.105%default, [200/0], 00:00:06, bgp-65020, internal, tag 6501
        0 (evpn) segid: 9999 tunnelid: 0xaff3269 encap: VXLAN

        192.168.15.0/24, ubest/mbest: 1/0, attached
            *via 192.168.15.1, Vlan15, [0/0], 08:11:02, direct
        192.168.15.1/32, ubest/mbest: 1/0, attached
            *via 192.168.15.1, Vlan15, [0/0], 08:11:02, local
        192.168.15.10/32, ubest/mbest: 1/0, attached
            *via 192.168.15.10, Vlan15, [190/0], 07:46:26, hmm
        192.168.15.20/32, ubest/mbest: 1/0
            *via 10.255.50.101%default, [200/0], 07:27:46, bgp-65020, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3265 encap: VXLAN
...
.
        ...
        Leaf1-4# sho bgp vrf VTBL all
        BGP routing table information for VRF VTBL, address family IPv4 Unicast
        BGP table version is 1092, Local Router ID is 192.168.2.1
        Status: s-suppressed, x-deleted, S-stale, d-dampened, h-history, *-valid, >-best
        Path type: i-internal, e-external, c-confed, l-local, a-aggregate, r-redist, I-i
        njected
        Origin codes: i - IGP, e - EGP, ? - incomplete, | - multipath, & - backup
        ...
        *>i192.168.2.10/32    10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        * i192.168.2.20/32    10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        *>i192.168.12.20/32   10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        * i192.168.15.20/32   10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i

        Leaf1-4# sho bgp l2vpn evpn
        BGP routing table information for VRF default, address family L2VPN EVPN
        BGP table version is 24803, Local Router ID is 10.255.11.4
        Status: s-suppressed, x-deleted, S-stale, d-dampened, h-history, *-valid, >-best
        Path type: i-internal, e-external, c-confed, l-local, a-aggregate, r-redist, I-i
        njected
        Origin codes: i - IGP, e - EGP, ? - incomplete, | - multipath, & - backup
        ...
        Network            Next Hop            Metric     LocPrf     Weight Path
        Route Distinguisher: 10.255.11.1:3
        * i[2]:[0]:[0]:[48]:[5000.0003.0007]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i

        Route Distinguisher: 10.255.11.1:32769
        * i[2]:[0]:[0]:[48]:[0050.7966.6813]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        * i[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i

        Route Distinguisher: 10.255.11.1:32779
        * i[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i

        Route Distinguisher: 10.255.11.1:32782
        *>i[2]:[0]:[0]:[48]:[0050.7966.6810]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        * i                   10.255.50.101                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        * i[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        ...
        Route Distinguisher: 10.255.11.2:3
        *>i[2]:[0]:[0]:[48]:[5000.0004.0007]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        * i                   10.255.50.101                     100          0 i

        Route Distinguisher: 10.255.11.2:32769
        *>i[2]:[0]:[0]:[48]:[0050.7966.6813]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        * i                   10.255.50.101                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
        ...
        * i                   10.255.50.101                     100          0 i
        ...
        Route Distinguisher: 10.255.11.2:32779
        *>i[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100          0 i
        * i                   10.255.50.101                     100          0 i

        Route Distinguisher: 10.255.11.2:32782
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
        ...
        * i                   10.255.50.101                     100          0 i
        ...
        Route Distinguisher: 10.255.11.4:32769    (L2VNI 10002)
        *>i[2]:[0]:[0]:[48]:[0050.7966.6812]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6813]:[0]:[0.0.0.0]/216
        ...
        * i[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        *>l[3]:[0]:[32]:[10.255.50.102]/88
                            10.255.50.102                     100      32768 i
        *>i[3]:[0]:[32]:[10.255.50.105]/88
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i

        Route Distinguisher: 10.255.11.4:32779    (L2VNI 10012)
        *>l[2]:[0]:[0]:[48]:[0050.7966.680e]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100      32768 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6811]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
                            10.255.50.102                     100      32768 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
                            10.255.50.105                     100          0 65010 i
        * i                   10.255.50.105                     100          0 65010 i
        ...
        * i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.11.4:32782    (L2VNI 10015)
        *>l[2]:[0]:[0]:[48]:[0050.7966.680f]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100      32768 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.680f]:[32]:[192.168.15.10]/272
                            10.255.50.102                     100      32768 i
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
                            10.255.50.101                     100          0 i
        *>i                   10.255.50.101                     100          0 i
        ...
        * i                   10.255.50.105                     100          0 65010 i
        ...
        Route Distinguisher: 10.255.11.4:3    (L3VNI 9999)
        *>i[2]:[0]:[0]:[48]:[5000.0003.0007]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
        *>i[2]:[0]:[0]:[48]:[5000.0004.0007]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 i
...
Выборочный вывод по хостам.   
        ...
        Leaf1-4# sho bgp l2vpn evpn | include 192.168.
        * i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
        ...
        * i[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
        * i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
...
*Leaf2-2*  
        ...
        Leaf2-2# sho nve peers
        Interface Peer-IP          State LearnType Uptime   Router-Mac
        --------- ---------------  ----- --------- -------- -----------------
        nve1      10.255.50.101    Up    CP        06:51:20 5000.0003.0007
        nve1      10.255.50.102    Up    CP        06:51:20 5000.0005.0007

.  

        Leaf2-2# show ip route vrf VTBL
        IP Route Table for VRF "VTBL"
        '*' denotes best ucast next-hop
        '**' denotes best mcast next-hop
        '[x/y]' denotes [preference/metric]
        ...
        192.168.2.0/24, ubest/mbest: 1/0, attached
            *via 192.168.2.1, Vlan2, [0/0], 06:49:44, direct
        192.168.2.1/32, ubest/mbest: 1/0, attached
            *via 192.168.2.1, Vlan2, [0/0], 06:49:44, local
        192.168.2.10/32, ubest/mbest: 1/0, attached
            *via 192.168.2.10, Vlan2, [190/0], 06:37:52, hmm
        192.168.2.20/32, ubest/mbest: 1/0
            *via 10.255.50.101%default, [200/0], 00:00:14, bgp-65010, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3265 encap: VXLAN

        192.168.12.0/24, ubest/mbest: 1/0, attached
            *via 192.168.12.1, Vlan12, [0/0], 06:49:43, direct
        192.168.12.1/32, ubest/mbest: 1/0, attached
            *via 192.168.12.1, Vlan12, [0/0], 06:49:43, local
        192.168.12.10/32, ubest/mbest: 1/0
            *via 10.255.50.102%default, [200/0], 00:00:14, bgp-65010, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3266 encap: VXLAN

        192.168.12.20/32, ubest/mbest: 1/0, attached
            *via 192.168.12.20, Vlan12, [190/0], 06:36:52, hmm
        192.168.15.0/24, ubest/mbest: 1/0, attached
            *via 192.168.15.1, Vlan15, [0/0], 06:49:43, direct
        192.168.15.1/32, ubest/mbest: 1/0, attached
            *via 192.168.15.1, Vlan15, [0/0], 06:49:43, local
        192.168.15.10/32, ubest/mbest: 1/0
            *via 10.255.50.102%default, [200/0], 00:00:14, bgp-65010, internal, tag 6502
        0 (evpn) segid: 9999 tunnelid: 0xaff3266 encap: VXLAN
...
.
        ...
        Leaf2-2# sho bgp vrf VTBL all
        BGP routing table information for VRF VTBL, address family IPv4 Unicast
        BGP table version is 3084, Local Router ID is 192.168.2.1
        Status: s-suppressed, x-deleted, S-stale, d-dampened, h-history, *-valid, >-best
        Path type: i-internal, e-external, c-confed, l-local, a-aggregate, r-redist, I-i
        njected
        Origin codes: i - IGP, e - EGP, ? - incomplete, | - multipath, & - backup
        ...
        Network            Next Hop            Metric     LocPrf     Weight Path
        *>i192.168.2.20/32    10.255.50.101                     100          0 65020 i
        * i                   10.255.50.101                     100          0 65020 i
        *>i192.168.12.10/32   10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
        *>i192.168.15.10/32   10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
        *>i192.168.15.20/32   10.255.50.101                     100          0 65020 i
        * i                   10.255.50.101                     100          0 65020 i

.

        Leaf2-2# sho bgp l2vpn evpn
        BGP routing table information for VRF default, address family L2VPN EVPN
        BGP table version is 48891, Local Router ID is 10.255.21.2
        Status: s-suppressed, x-deleted, S-stale, d-dampened, h-history, *-valid, >-best
        Path type: i-internal, e-external, c-confed, l-local, a-aggregate, r-redist, I-i
        njected
        Origin codes: i - IGP, e - EGP, ? - incomplete, | - multipath, & - backup
        ...
        * i                   10.255.50.102                     100          0 65020 i
        ...
        Route Distinguisher: 10.255.21.2:32769    (L2VNI 10002)
        *>l[2]:[0]:[0]:[48]:[0050.7966.6812]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100      32768 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6813]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 65020 i
        * i                   10.255.50.101                     100          0 65020 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
                            10.255.50.105                     100      32768 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
                            10.255.50.101                     100          0 65020 i
        * i                   10.255.50.101                     100          0 65020 i
        ...
        *>i[3]:[0]:[32]:[10.255.50.102]/88
                            10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
        *>l[3]:[0]:[32]:[10.255.50.105]/88
                            10.255.50.105                     100      32768 i

        Route Distinguisher: 10.255.21.2:32779    (L2VNI 10012)
        *>i[2]:[0]:[0]:[48]:[0050.7966.680e]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
        ...
        *>i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
                            10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
        *>l[2]:[0]:[0]:[48]:[0050.7966.6811]:[32]:[192.168.12.20]/272
                            10.255.50.105                     100      32768 i
        *>i[3]:[0]:[32]:[10.255.50.101]/88
                            10.255.50.101                     100          0 65020 i
        * i                   10.255.50.101                     100          0 65020 i
        ...
        *>l[3]:[0]:[32]:[10.255.50.105]/88
        ...
        Route Distinguisher: 10.255.21.2:32782    (L2VNI 10015)
        *>i[2]:[0]:[0]:[48]:[0050.7966.680f]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.6810]:[0]:[0.0.0.0]/216
        ...
        *>l[3]:[0]:[32]:[10.255.50.105]/88
        ...
        Route Distinguisher: 10.255.21.2:3    (L3VNI 9999)
        *>i[2]:[0]:[0]:[48]:[5000.0003.0007]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 65020 i
        *>i[2]:[0]:[0]:[48]:[5000.0004.0007]:[0]:[0.0.0.0]/216
                            10.255.50.101                     100          0 65020 i
        ...
        *>i[2]:[0]:[0]:[48]:[5000.0006.0007]:[0]:[0.0.0.0]/216
                            10.255.50.102                     100          0 65020 i
        *>l[2]:[0]:[0]:[48]:[5000.0009.0007]:[0]:[0.0.0.0]/216
                            10.255.50.105                     100      32768 i
        *>i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
                            10.255.50.102                     100          0 65020 i
        * i                   10.255.50.102                     100          0 65020 i
...
Выборочный вывод по хостам.  
        ...
        Leaf2-2# sho bgp l2vpn evpn | include 192.168.
        x i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.6810]:[32]:[192.168.15.20]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.680f]:[32]:[192.168.15.10]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.680e]:[32]:[192.168.12.10]/272
        x i[2]:[0]:[0]:[48]:[0050.7966.680f]:[32]:[192.168.15.10]/272
        *>l[2]:[0]:[0]:[48]:[0050.7966.6812]:[32]:[192.168.2.10]/272
        *>i[2]:[0]:[0]:[48]:[0050.7966.6813]:[32]:[192.168.2.20]/272
...
**5. ПРОВЕРКА СЕТЕВОЙ СВЯЗАННОСТИ ХОСТОВ**  

VPC14  
   ![](CommandResults/VPC14.png) 

VPC16  
   ![](CommandResults/VPC16.png) 

VPC17   
   ![](CommandResults/VPC17.png) 

VPC19  
   ![](CommandResults/VPC19.png) 
